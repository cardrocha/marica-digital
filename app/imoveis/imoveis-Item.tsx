...
export default function ImoveisItem({ property }: { property: Property }) {
  return (
    <div className="flex flex-col gap-4 justify-end p-4 bg-purple-300 rounded-md shadow-md">
      ...
      <Button className="bg-gradient-to-r from-fuchsia-900 to-purple-800 hover:brightness-200 transition-colors py-2 rounded-sm text-xl text-center font-bold cursor-pointer">
